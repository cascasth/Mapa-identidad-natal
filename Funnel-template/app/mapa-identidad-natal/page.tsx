    ...
    <main style={{ background: bg, color: "#f5f0e8" }} className="min-h-screen">
      <div className="w-full max-w-sm mx-auto px-5 pb-24">
        ...
        <section className="pt-14 pb-10 text-center flex flex-col gap-5 border-b border-slate-800/60">
          ...
          <a href="https://[TU-DOMINIO]/#payment-step" target="_blank" rel="noopener noreferrer" style={ctaStyle} className="w-full py-4 rounded-2xl text-sm tracking-wide active:scale-95 transition-all text-center block">
        ...
        <Section title="Tu Mapa de Identidad Natal incluye:">
          ...
          <a href="https://[TU-DOMINIO]/#payment-step" target="_blank" rel="noopener noreferrer" style={ctaStyle} className="w-full py-4 rounded-2xl text-sm tracking-wide active:scale-95 transition-all mt-5 text-center block">
      ...
      {showSticky && (
        <div className="fixed bottom-0 left-0 right-0 p-4 z-50 animate-fade-in"
          ...
          <div className="max-w-sm mx-auto">
            <a href="https://[TU-DOMINIO]/#payment-step" target="_blank" rel="noopener noreferrer" style={ctaStyle} className="w-full py-4 rounded-2xl text-sm tracking-wide active:scale-95 transition-all shadow-2xl text-center block">
              Recibir mi Mapa de Identidad Natal
            </a>
          </div>
        </div>
