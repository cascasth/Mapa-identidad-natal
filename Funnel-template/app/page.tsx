  ...
  return (
    <div className="relative flex items-center justify-center" style={{ width: 220, height: 220 }}>
      ...
      <div className="w-24 h-24 rounded-full overflow-hidden relative z-10">
        <Image src="/avatar-sabia.jpg" alt="[NOMBRE_DEL_NEGOCIO]" width={96} height={96} className="object-cover w-full h-full" />
      </div>
    </div>
  );
}
      ...
      {screen === "incoming" && (
        <div className="animate-fade-in w-full max-w-sm mx-auto relative z-10">
          <div className="rounded-2xl flex flex-col items-center relative overflow-hidden py-10 px-6" style={{ ...cardStyle, minHeight: "520px" }}>
            ...
            {/* Nombre */}
            <h1 className="text-white text-2xl font-light tracking-wide mb-1">[NOMBRE_DEL_NEGOCIO]</h1>

            {/* Subtítulo */}
            <p className="text-sm mb-8" style={{ color: "rgba(180,130,40,0.55)" }}>✦ [NOMBRE_DEL_PRODUCTO] ✦</p>
            ...
            <div className="relative flex items-center justify-center mb-10" style={{ width: 220, height: 220 }}>
              ...
              <div className="w-36 h-36 rounded-full overflow-hidden border-2 border-amber-400/30 relative z-10">
                <Image src="/avatar-sabia.jpg" alt="[NOMBRE_DEL_NEGOCIO]" width={144} height={144} className="object-cover w-full h-full" />
              </div>
            </div>
      ...
      {screen === "active" && (
        <div className="animate-fade-in w-full max-w-sm mx-auto relative z-10">
          <div className="rounded-2xl flex flex-col items-center relative overflow-hidden" style={{ ...cardStyle, paddingTop: "2rem", paddingBottom: "2rem" }}>
            ...
            {/* Nombre */}
            <p className="text-white text-2xl font-light tracking-wide mb-1">[NOMBRE_DEL_NEGOCIO]</p>
